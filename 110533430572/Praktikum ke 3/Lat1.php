...
<form action="<?php $_SERVER['PHP_SELF'];?>" method="get"> <!--untuk membuat suatu form HTML dan memiliki atribut method bernilai get
Nama
<input type="text" name="nama" /> <br /> <!-- input masukannya berupa teks -->
